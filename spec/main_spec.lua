...
describe("suwayomi plugin", function()
    ...
    it("cancels queued downloads and skips active downloads before bulk delete", function()
        ...
        assert.are.equal("Deleted 1 selected chapter from device. Canceled 1 queued download. 1 download is still in progress.", shown_messages[#shown_messages])
    end)
...
return {
    [1] = {
        ...
        assert.are.equal("Official_Vol. 1 Ch. 5 [read] [downloaded]", shown_chapter_menu.chapters[1].menu_text)
